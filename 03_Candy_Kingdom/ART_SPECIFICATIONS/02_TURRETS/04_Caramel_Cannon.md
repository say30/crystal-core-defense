...
- Clé Roblox/configuration : `CaramelCannon`
- Damage : **8000**
- Range : **37.5**
- FireRate : **1.64**
- Health : **8480**
...
- Modèle complet : `CaramelCannon.rbxm`
- Texture/SurfaceAppearance : `CaramelCannon_Color.png` et cartes nécessaires
- Icône transparente : `CaramelCannon_Icon.png`
- Projectile ou rayon : `CaramelCannon_Projectile`
- Effet de tir : `CaramelCannon_MuzzleFX`
- Effet d’impact : `CaramelCannon_ImpactFX`
- Effet de destruction : `CaramelCannon_DestroyFX`
- Son de tir : `CaramelCannon_FireSound`
