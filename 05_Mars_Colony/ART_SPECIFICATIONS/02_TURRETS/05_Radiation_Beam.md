...
- Clé Roblox/configuration : `RadiationBeam`
- Damage : **360000**
- Range : **40**
- FireRate : **1.52**
- Health : **288000**
...
- Modèle complet : `RadiationBeam.rbxm`
- Texture/SurfaceAppearance : `RadiationBeam_Color.png` et cartes nécessaires
- Icône transparente : `RadiationBeam_Icon.png`
- Projectile ou rayon : `RadiationBeam_Projectile`
- Effet de tir : `RadiationBeam_MuzzleFX`
- Effet d’impact : `RadiationBeam_ImpactFX`
- Effet de destruction : `RadiationBeam_DestroyFX`
- Son de tir : `RadiationBeam_FireSound`
