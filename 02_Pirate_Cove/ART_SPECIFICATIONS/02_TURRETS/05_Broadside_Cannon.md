...
- Clé Roblox/configuration : `BroadsideCannon`
- Damage : **2400**
- Range : **40**
- FireRate : **1.52**
- Health : **1920**
...
- Modèle complet : `BroadsideCannon.rbxm`
- Texture/SurfaceAppearance : `BroadsideCannon_Color.png` et cartes nécessaires
- Icône transparente : `BroadsideCannon_Icon.png`
- Projectile ou rayon : `BroadsideCannon_Projectile`
- Effet de tir : `BroadsideCannon_MuzzleFX`
- Effet d’impact : `BroadsideCannon_ImpactFX`
- Effet de destruction : `BroadsideCannon_DestroyFX`
- Son de tir : `BroadsideCannon_FireSound`
